...
from api.routers import analysis, data, catalog, hydro, hydro_dispatch, hydro_tasks
...
app.include_router(hydro_dispatch.router, prefix="/api/hydro", tags=["HydroAgent-XW Dispatch"])
